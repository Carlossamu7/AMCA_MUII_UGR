...
def main():
    ...
    _, per[3], err[3], fac[3] = experiment(x_square, [0, 2*np.pi], 512, thresholding, 0.005, "xsen(x)+xcos(x) en [0,2π] (N=512, ε=0.005)")
    _, per[4], err[4], fac[4] = experiment(x_square, [0, 2*np.pi], 512, thresholding, 0.02, "xsen(x)+xcos(x) en [0,2π] (N=512, ε=0.02)")
    _, per[5], err[5], fac[5] = experiment(x_square, [0, 2*np.pi], 512, thresholding, 0.08, "xsen(x)+xcos(x) en [0,2π] (N=512, ε=0.08)")
    ...
    optimization_thr(x_square, [0, 2*np.pi], 512, "xsen(x)+xcos(x) en [0,2π]")
    optimization_N(math.sin, [0, 2*np.pi], 0.05, "sen(x) en [0,2π]")
    optimization_N(x_square, [0, 2*np.pi], 0.05, "xsen(x)+xcos(x) en [0,2π]")
    optimization_thr_N(math.sin, [0, 2*np.pi], "sen(x) en [0,2π]")
    optimization_thr_N(x_square, [0, 2*np.pi], "xsen(x)+xcos(x) en [0,2π]")
